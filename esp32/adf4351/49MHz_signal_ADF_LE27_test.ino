...
// Standalone ADF4351 test wiring:
// CE   -> ESP32 GPIO 25
// LE   -> ESP32 GPIO 27
// DATA -> ESP32 GPIO 23 (SPI MOSI)
// CLK  -> ESP32 GPIO 18 (SPI SCK)
// GND  -> ESP32 GND
// MUX and LD are unused.

constexpr int ADF4351_CE_PIN = 25;
constexpr int ADF4351_LE_PIN = 27;
constexpr int ADF4351_DATA_PIN = 23;
constexpr int ADF4351_CLK_PIN = 18;
...
void setup() {
  ...
  Serial.println();
  Serial.println("ADF4351 standalone GPIO 27 LE test");
  ...
  Serial.println("SPI started: CLK 18, DATA 23, LE 27");
  Serial.println("ADF4351 CE set HIGH on GPIO 25");

  // Preserve the settings from the previously working PLL sketch.
  vfo.pwrlevel = 3;
  vfo.RD2refdouble = 0;
  vfo.RD1Rdiv2 = 0;
  vfo.ClkDiv = 150;
